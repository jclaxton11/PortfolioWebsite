<html>
    ...
    <body class="MainBody">
        ...
        <div class="flex-container">
            ...
            <div class="flex-item">
                <h3>Java</h3> 
                <img src="images/javalogo.png" alt="Java" width="200", height="200">
             </div>
            <div class="flex-item">
                <h3>Python</h3> 
                <img src="images/pythonImage.png" alt="python" width="200", height="200">
             </div>
             <div class="flex-item">
                <h3>Swift</h3> 
                <img src="images/swiftImage.png" alt="swift" width="200", height="200">
             </div>
             <div class="flex-item">
                <h3>HTML/CSS</h3> 
                <img src="images/htmlimage.png" alt="HTML" width="200", height="200">
             </div>
             <div class="flex-item">
                <h3>PHP</h3> 
